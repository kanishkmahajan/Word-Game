var words = [
	    ...
	    },
	{
		...
		meaning: "Dismiss",
		use: "The judge dismissed the charges, saying there was insufficient proof.",
		...
		},
	{
		...
		meaning: "Dissemble",
		use: "Her plan was to dissemble her intentions from her husband so she could successfully plan him a surprise party.",
		...
		},
	{
		...
		meaning: "Facilitate",
		use: "The translator will facilitate the conversation between the immigrant and the attorney.",
	    ...
	    },
	{
		word: "Not Material",
		meaning: "Intangible",
		use: "While emotions can be expressed, they are intangible because they cannot be physically touched.",
		...
		},
	{
		...
		meaning: "Luminous",
		use: "The movie editor used the computer program to give the actress the luminous appearance of an angel.",
	    ...
	    },
	{
		...
		meaning: "Meticulous",
		use: "Because Halen is a meticulous cleaner, every inch of her house is spotless.",
		...
		},
	{
		...
		meaning: "Nostalgia",
		use: "My grandmother says the jazz music triggers nostalgia for her youth.",
	    ...
	    },
	{
		word: "Rash",
		meaning: "Precipitate",
		use: "The rising level of unemployment is going to precipitate a huge crowd at the welfare office. ",
	    ...
	    },
	{
		...
		meaning: "Resolution",
		use: "His New Year’s resolution was to run three times a week, but only a month into the year he had already failed.",
		...
		},
	{
		word: "To Satisfy",
		meaning: "Satiate",
		use: "Hopefully this feast I am preparing will satiate your hunger.",
	    ...
	    },
	{
		...
		meaning: "Transient",
		use: "The snow is transient and will melt as soon as the sun appears.",
...
resetButton.addEventListener("click", function(){
	...
	for (var i = 0; i < squares.length; i++){
		...
		stripe.style.background = "lightgrey";
	}
})
